...
class DPCDataset(VQA2Dataset):
    def __init__(self, config, dataset_type, imdb_file_index, *args, **kwargs):
        super().__init__(
            config, dataset_type, imdb_file_index, dataset_name="dpc", *args, **kwargs
        )

    def preprocess_sample_info(self, sample_info):
        # DPC Annotation DBs have corrext feature_path
        # if "dpc" not in sample_info["feature_path"]:
